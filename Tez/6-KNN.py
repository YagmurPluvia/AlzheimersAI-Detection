...
accuracy = accuracy_score(np.argmax(test_labels, axis=1), labels_pred_flat)
f1 = f1_score(np.argmax(test_labels, axis=1), labels_pred_flat, average='weighted')
kappa = cohen_kappa_score(np.argmax(test_labels, axis=1), labels_pred_flat)
